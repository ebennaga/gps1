            ...
            success: function (data) {
                ...
                for (let i in data) {
                    ...
                    if(i !== '') {
                        ...
                        getDataHistoryShip = getDataHistoryShip + '<tr class="header2" style="background-color: #023342; color:#fff;"><td colspan="2" style ="height:19px; padding-left:5px; font-weight: 500;"> Unassigned Manager</td></tr>';
                    }
                    for (const j in data[i]) {
                        ...
                        if(i !== '') {
                            ...
                            getDataShip = getDataShip + '<tr class="header"><td colspan="4" style="padding-left: 7px"><input type="checkbox" id="top' + topKing + '" name="' + king + '" checked="checked"/>&nbsp;' + damaskus + '</td> </tr>';
                            getDataHistoryShip = getDataHistoryShip + '<tr class="header" style="height:20px;"><td colspan="2" style="padding-left: 10px; font-weight: 500;">' + damaskus + '</td>/tr>';
                        }
